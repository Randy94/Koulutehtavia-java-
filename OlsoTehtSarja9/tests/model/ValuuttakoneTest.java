...
public class ValuuttakoneTest {
	...
	/*
	 * Teht 4 testi: poista kommenteista kun olet toteuttanut metodin
	 * getVaihtoehdot()
	 */
	@Test
	...
	public void testGetVaihtoehdot() {
		...
		// Jos oltava sama järjestys kuin tehtävänkuvassa,  voi verrata kokonaisia taulukoita
		// assertArrayEquals(expected, vaihtoehdot, 
        //  				 "Valuuttojen nimitaulu ei sama kuin tehtävän kuvassa");

		// Jos ei, niin tsekkaa yksitellen onko nuo neljä taulukossa jossain
		// järjestyksessä
